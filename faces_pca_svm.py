...
#Prints the amount of images and the amount of pixels in each image
...
# Plot the first 20 of these faces.
for i in range(20):
...
#Split the dataset in a train and a test dataset.
X_train, X_test, y_train, y_test = train_test_split(faces.data,
                                                    faces.target, random_state=0)
#Prints the amount of images used for training and testing
print(X_train.shape, X_test.shape)

# Lets downscale the orginal pics with PCA

# n_components = Number of components to keep,
# Whitening = true can sometimes improve the predictive accuracy of the downstream estimators
...
# Lets look at the first 25 pics in the test set.
fig = plt.figure(figsize=(8, 6))
for i in range(25):
...
#evaluating how well the face recognition model performs.
